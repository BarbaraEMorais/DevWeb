    ...
    <body>
        <div class="container">
            ...
            <div class="mt-5">
                ...
                <a href="/aplicacaoMVC/RegistroCliente?acao=Incluir" class="mb-2 btn btn-primary">Incluir</a>
                        ...
                        <tbody>
                            <%
                                ...
                                for (Cliente cliente : listaClientes) {
                                    ...
                                    %>
                            <td>
                            <a href="/aplicacaoMVC/RegistroCliente?acao=Alterar&id=<%=cliente.getId()%>" class="btn btn-warning">Alterar</a>
                            <a href="/aplicacaoMVC/RegistroCliente?acao=Excluir&id=<%=cliente.getId()%>" class="btn btn-danger">Excluir</a></td>
