...
public class UsuarioDAO {
    ...
    public void Inserir(Usuario usuario) throws Exception {
        ...
        try {
            PreparedStatement sql = conexao.getConexao().prepareStatement("INSERT INTO funcionarios (nome, cpf, papel, senha)"
                    + " VALUES (?,?,?,?)");
        ...
        try {
            ...
            if (resultado != null) {
                while (resultado.next()) {
                    ...
                    usuarioObtido.setPapel(resultado.getString("PAPEL"));
